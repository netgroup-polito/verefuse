...
/**
 * <p>Classe Java per rangeSettings.
 * 
...
public enum RangeSettings {
    ...
    public static RangeSettings fromValue(String v) {
        for (RangeSettings c: RangeSettings.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
