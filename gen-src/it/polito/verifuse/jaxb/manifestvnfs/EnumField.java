 ...
 * 
 */
@XmlType(name = "enumField", namespace = "http://www.verifuse.polito.it/fieldsmanifest")
@XmlEnum
public enum EnumField {
    ...
    public static EnumField fromValue(String v) {
        for (EnumField c: EnumField.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
