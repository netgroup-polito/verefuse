...
@XmlRootElement(name = "FieldsManifest", namespace = "http://www.verifuse.polito.it/fieldsmanifest")
public class FieldsManifest {

    @XmlElement(name = "Field", namespace = "http://www.verifuse.polito.it/fieldsmanifest", required = true)
    ...
    public static class Field {
        ...
        @XmlElement(name = "Supports", namespace = "http://www.verifuse.polito.it/fieldsmanifest")
