...
@XmlRootElement(name = "ActionsManifest", namespace = "http://www.verifuse.polito.it/actionsmanifest")
public class ActionsManifest {

    @XmlElement(name = "ActionSupport", namespace = "http://www.verifuse.polito.it/actionsmanifest", required = true)
    ...
    public static class ActionSupport {
        ...
        @XmlElement(name = "Support", namespace = "http://www.verifuse.polito.it/actionsmanifest")
