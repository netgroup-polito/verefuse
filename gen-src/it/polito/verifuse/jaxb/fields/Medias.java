...
/**
 * <p>Classe Java per Medias complex type.
 * 
 ...
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;attribute name="Type" use="required" type="{http://www.verifuse.polito.it/fields}MediaType" />
...
@XmlType(name = "Medias", propOrder = {
    "media"
})
public class Medias {

    @XmlElement(name = "Media", required = true)
    protected List<Medias.Media> media;
     ...
     * 
     */
    public List<Medias.Media> getMedia() {
        if (media == null) {
            media = new ArrayList<Medias.Media>();
        }
        return this.media;
    }
