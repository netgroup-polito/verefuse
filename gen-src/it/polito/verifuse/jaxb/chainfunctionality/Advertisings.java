...
/**
 * <p>Classe Java per Advertisings complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="Advertising" maxOccurs="unbounded">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
...
@XmlType(name = "Advertisings", propOrder = {
    "advertising"
})
public class Advertisings {

    @XmlElement(name = "Advertising", required = true)
    protected List<Advertisings.Advertising> advertising;
     ...
     * {@link Advertisings.Advertising }
     * 
     * 
     */
    public List<Advertisings.Advertising> getAdvertising() {
        if (advertising == null) {
            advertising = new ArrayList<Advertisings.Advertising>();
        }
