...
public class Scalability_test_requirement_not_order_realistic_1000vnfs {
	...
	private void writeOnFile(int testNumber, long time,int numberThread,int n_req,int vnfs) throws IOException {
	    ...
	    writer.append("REAL_NOT_ORDER_REQUIREMENT_TEST_" + testNumber + "\tTime: " + time + " ms\tThreads: "+numberThread+"\tNRequ:"+n_req+"\tVNFS:\t"+vnfs+"\n");
	    writer.close();
	}
	...
	public void testScalability10()	{
		try	{
			...
			writeOnFile(1, totalTime,Consts.NUMBERTHREAD,10,1000);
		}
		catch (Exception e) {
	...
	public void testScalability20()	{
		try	{
			...
			long endTime = System.currentTimeMillis();
			long totalTime = endTime - startTime;
			writeOnFile(2, totalTime,Consts.NUMBERTHREAD,20,1000);
		}
		catch (Exception e) {
			fail("Exception during the test.\nMsg:" + e.getMessage());
		}
	...
	public void testScalability30()	{
		try	{
			...
			long endTime = System.currentTimeMillis();
			long totalTime = endTime - startTime;
			writeOnFile(3, totalTime,Consts.NUMBERTHREAD,30,1000);
		}
		catch (Exception e) {
			fail("Exception during the test.\nMsg:" + e.getMessage());
		}
	...
	public void testScalability40()	{
		try	{
			...
			long endTime = System.currentTimeMillis();
			long totalTime = endTime - startTime;
			writeOnFile(4, totalTime,Consts.NUMBERTHREAD,40,1000);
		}
		catch (Exception e) {
			fail("Exception during the test.\nMsg:" + e.getMessage());
		}
	...
	public void testScalability50()	{
		try	{
			...
			long endTime = System.currentTimeMillis();
			long totalTime = endTime - startTime;
			writeOnFile(5, totalTime,Consts.NUMBERTHREAD,50,1000);
		}
		catch (Exception e) {
			fail("Exception during the test.\nMsg:" + e.getMessage());
		}
	...
	public void testScalability60()	{
		try	{
			...
			long endTime = System.currentTimeMillis();
			long totalTime = endTime - startTime;
			writeOnFile(6, totalTime,Consts.NUMBERTHREAD,60,1000);
		}
		catch (Exception e) {
			fail("Exception during the test.\nMsg:" + e.getMessage());
		}
	...
	public void testScalability70()	{
		try	{
			...
			long endTime = System.currentTimeMillis();
			long totalTime = endTime - startTime;
			writeOnFile(7, totalTime,Consts.NUMBERTHREAD,70,1000);
		}
		catch (Exception e) {
			fail("Exception during the test.\nMsg:" + e.getMessage());
		}
	...
	public void testScalability80()	{
		try	{
			...
			long endTime = System.currentTimeMillis();
			long totalTime = endTime - startTime;
			writeOnFile(8, totalTime,Consts.NUMBERTHREAD,80,1000);
		}
		catch (Exception e) {
			fail("Exception during the test.\nMsg:" + e.getMessage());
		}
	...
	public void testScalability90()	{
		try	{
			...
			long endTime = System.currentTimeMillis();
			long totalTime = endTime - startTime;
			writeOnFile(9, totalTime,Consts.NUMBERTHREAD,90,1000);
		}
		catch (Exception e) {
			fail("Exception during the test.\nMsg:" + e.getMessage());
		}
	...
	public void testScalbility100()	{
		try	{
			...
			long endTime = System.currentTimeMillis();
			long totalTime = endTime - startTime;
			writeOnFile(10, totalTime,Consts.NUMBERTHREAD,100,1000);
		}
		catch (Exception e) {
			fail("Exception during the test.\nMsg:" + e.getMessage());
		}
	...
	public void testScalbility200()	{
		try	{
			...
			long endTime = System.currentTimeMillis();
			long totalTime = endTime - startTime;
			writeOnFile(11, totalTime,Consts.NUMBERTHREAD,200,1000);
		}
		catch (Exception e) {
			fail("Exception during the test.\nMsg:" + e.getMessage());
		}
	...
	public void testScalbility300()	{
		try	{
			...
			long endTime = System.currentTimeMillis();
			long totalTime = endTime - startTime;
			writeOnFile(12, totalTime,Consts.NUMBERTHREAD,300,1000);
		}
		catch (Exception e) {
			fail("Exception during the test.\nMsg:" + e.getMessage());
		}
	...
	public void testScalbility400()	{
		try	{
			...
			long endTime = System.currentTimeMillis();
			long totalTime = endTime - startTime;
			writeOnFile(13, totalTime,Consts.NUMBERTHREAD,400,1000);
		}
		catch (Exception e) {
			fail("Exception during the test.\nMsg:" + e.getMessage());
		}
	...
	public void testScalbility500()	{
		try	{
			...
			long endTime = System.currentTimeMillis();
			long totalTime = endTime - startTime;
			writeOnFile(14, totalTime,Consts.NUMBERTHREAD,500,1000);
		}
		catch (Exception e) {
			fail("Exception during the test.\nMsg:" + e.getMessage());
		}
	...
	public void testScalbility600()	{
		try	{
			...
			long endTime = System.currentTimeMillis();
			long totalTime = endTime - startTime;
			writeOnFile(15, totalTime,Consts.NUMBERTHREAD,600,1000);
		}
		catch (Exception e) {
			fail("Exception during the test.\nMsg:" + e.getMessage());
		}
	...
	public void testScalbility700()	{
		try	{
			...
			long endTime = System.currentTimeMillis();
			long totalTime = endTime - startTime;
			writeOnFile(16, totalTime,Consts.NUMBERTHREAD,700,1000);
		}
		catch (Exception e) {
			fail("Exception during the test.\nMsg:" + e.getMessage());
		}
	...
	public void testScalbility800()	{
		try	{
			...
			long endTime = System.currentTimeMillis();
			long totalTime = endTime - startTime;
			writeOnFile(17, totalTime,Consts.NUMBERTHREAD,800,1000);
		}
		catch (Exception e) {
			fail("Exception during the test.\nMsg:" + e.getMessage());
		}
	...
	public void testScalbility900()	{
		try	{
			...
			long endTime = System.currentTimeMillis();
			long totalTime = endTime - startTime;
			writeOnFile(18, totalTime,Consts.NUMBERTHREAD,900,1000);
		}
		catch (Exception e) {
			fail("Exception during the test.\nMsg:" + e.getMessage());
		}
	...
	public void testScalbility2000()	{
		try	{
			...
			long endTime = System.currentTimeMillis();
			long totalTime = endTime - startTime;
			writeOnFile(20, totalTime,Consts.NUMBERTHREAD,2000,1000);
		}
		catch (Exception e) {
			fail("Exception during the test.\nMsg:" + e.getMessage());
		}
	...
	public void testScalbility3000()	{
		try	{
			...
			long endTime = System.currentTimeMillis();
			long totalTime = endTime - startTime;
			writeOnFile(21, totalTime,Consts.NUMBERTHREAD,3000,1000);
		}
		catch (Exception e) {
			fail("Exception during the test.\nMsg:" + e.getMessage());
		}
	...
	public void testScalbility4000()	{
		try	{
			...
			long endTime = System.currentTimeMillis();
			long totalTime = endTime - startTime;
			writeOnFile(22, totalTime,Consts.NUMBERTHREAD,4000,1000);
		}
		catch (Exception e) {
			fail("Exception during the test.\nMsg:" + e.getMessage());
		}
	...
	public void testScalbility5000()	{
		try	{
			...
			long endTime = System.currentTimeMillis();
			long totalTime = endTime - startTime;
			writeOnFile(23, totalTime,Consts.NUMBERTHREAD,5000,1000);
		}
		catch (Exception e) {
			fail("Exception during the test.\nMsg:" + e.getMessage());
		}
	...
	public void testScalbility6000()	{
		try	{
			...
			long endTime = System.currentTimeMillis();
			long totalTime = endTime - startTime;
			writeOnFile(24, totalTime,Consts.NUMBERTHREAD,6000,1000);
		}
		catch (Exception e) {
			fail("Exception during the test.\nMsg:" + e.getMessage());
		}
	...
	public void testScalbility7000()	{
		try	{
			...
			long endTime = System.currentTimeMillis();
			long totalTime = endTime - startTime;
			writeOnFile(25, totalTime,Consts.NUMBERTHREAD,7000,1000);
		}
		catch (Exception e) {
			fail("Exception during the test.\nMsg:" + e.getMessage());
		}
	...
	public void testScalbility8000()	{
		try	{
			...
			long endTime = System.currentTimeMillis();
			long totalTime = endTime - startTime;
			writeOnFile(26, totalTime,Consts.NUMBERTHREAD,8000,1000);
		}
		catch (Exception e) {
			fail("Exception during the test.\nMsg:" + e.getMessage());
		}
	...
	public void testScalbility9000()	{
		try	{
			...
			long endTime = System.currentTimeMillis();
			long totalTime = endTime - startTime;
			writeOnFile(27, totalTime,Consts.NUMBERTHREAD,9000,1000);
		}
		catch (Exception e) {
			fail("Exception during the test.\nMsg:" + e.getMessage());
		}
	...
	public void testScalbility10000(){
		try	{
			...
			long endTime = System.currentTimeMillis();
			long totalTime = endTime - startTime;
			writeOnFile(28, totalTime,Consts.NUMBERTHREAD,10000,1000);
		}
		catch (Exception e) {
			fail("Exception during the test.\nMsg:" + e.getMessage());
		}
	...
	public void testScalbility20000(){
		try	{
			...
			long endTime = System.currentTimeMillis();
			long totalTime = endTime - startTime;
			writeOnFile(29, totalTime,Consts.NUMBERTHREAD,20000,1000);
		}
		catch (Exception e) {
			fail("Exception during the test.\nMsg:" + e.getMessage());
		}
	...
	public void testScalbility30000(){
		try	{
			...
			long endTime = System.currentTimeMillis();
			long totalTime = endTime - startTime;
			writeOnFile(30, totalTime,Consts.NUMBERTHREAD,30000,1000);
		}
		catch (Exception e) {
			fail("Exception during the test.\nMsg:" + e.getMessage());
		}
	...
	public void testScalbility40000(){
		try	{
			...
			long endTime = System.currentTimeMillis();
			long totalTime = endTime - startTime;
			writeOnFile(31, totalTime,Consts.NUMBERTHREAD,40000,1000);
		}
		catch (Exception e) {
			fail("Exception during the test.\nMsg:" + e.getMessage());
		}
	...
	public void testScalbility50000(){
		try	{
			...
			long endTime = System.currentTimeMillis();
			long totalTime = endTime - startTime;
			writeOnFile(32, totalTime,Consts.NUMBERTHREAD,50000,1000);
		}
		catch (Exception e) {
			fail("Exception during the test.\nMsg:" + e.getMessage());
		}
	...
	public void testScalbility60000(){
		try	{
			...
			long endTime = System.currentTimeMillis();
			long totalTime = endTime - startTime;
			writeOnFile(33, totalTime,Consts.NUMBERTHREAD,60000,1000);
		}
		catch (Exception e) {
			fail("Exception during the test.\nMsg:" + e.getMessage());
		}
	...
	public void testScalbility70000(){
		try	{
			...
			long endTime = System.currentTimeMillis();
			long totalTime = endTime - startTime;
			writeOnFile(34, totalTime,Consts.NUMBERTHREAD,70000,1000);
		}
		catch (Exception e) {
			fail("Exception during the test.\nMsg:" + e.getMessage());
		}
	...
	public void testScalbility80000(){
		try	{
			...
			long endTime = System.currentTimeMillis();
			long totalTime = endTime - startTime;
			writeOnFile(35, totalTime,Consts.NUMBERTHREAD,80000,1000);
		}
		catch (Exception e) {
			fail("Exception during the test.\nMsg:" + e.getMessage());
		}
	...
	public void testScalbility90000(){
		try	{
			...
			long endTime = System.currentTimeMillis();
			long totalTime = endTime - startTime;
			writeOnFile(36, totalTime,Consts.NUMBERTHREAD,90000,1000);
		}
		catch (Exception e) {
			fail("Exception during the test.\nMsg:" + e.getMessage());
		}
	...
	public void testScalbility100000()	{
		try	{
			...
			long endTime = System.currentTimeMillis();
			long totalTime = endTime - startTime;
			writeOnFile(37, totalTime,Consts.NUMBERTHREAD,100000,1000);
		}
		catch (Exception e) {
			fail("Exception during the test.\nMsg:" + e.getMessage());
		}
	...
	public void testScalbility200000()	{
		try	{
			...
			long endTime = System.currentTimeMillis();
			long totalTime = endTime - startTime;
			writeOnFile(38, totalTime,Consts.NUMBERTHREAD,200000,1000);
		}
		catch (Exception e) {
			fail("Exception during the test.\nMsg:" + e.getMessage());
		}
	...
	public void testScalbility300000()	{
		try	{
			...
			long endTime = System.currentTimeMillis();
			long totalTime = endTime - startTime;
			writeOnFile(39, totalTime,Consts.NUMBERTHREAD,300000,1000);
		}
		catch (Exception e) {
			fail("Exception during the test.\nMsg:" + e.getMessage());
		}
	...
	public void testScalbility400000()	{
		try	{
			...
			long endTime = System.currentTimeMillis();
			long totalTime = endTime - startTime;
			writeOnFile(40, totalTime,Consts.NUMBERTHREAD,400000,1000);
		}
		catch (Exception e) {
			fail("Exception during the test.\nMsg:" + e.getMessage());
		}
	...
	public void testScalbility500000()	{
		try	{
			...
			long endTime = System.currentTimeMillis();
			long totalTime = endTime - startTime;
			writeOnFile(41, totalTime,Consts.NUMBERTHREAD,500000,1000);
		}
		catch (Exception e) {
			fail("Exception during the test.\nMsg:" + e.getMessage());
		}
	...
	public void testScalbility600000()	{
		try	{
			...
			long endTime = System.currentTimeMillis();
			long totalTime = endTime - startTime;
			writeOnFile(42, totalTime,Consts.NUMBERTHREAD,600000,1000);
		}
		catch (Exception e) {
			fail("Exception during the test.\nMsg:" + e.getMessage());
		}
	...
	public void testScalbility700000()	{
		try	{
			...
			long endTime = System.currentTimeMillis();
			long totalTime = endTime - startTime;
			writeOnFile(43, totalTime,Consts.NUMBERTHREAD,700000,1000);
		}
		catch (Exception e) {
			fail("Exception during the test.\nMsg:" + e.getMessage());
		}
	...
	public void testScalbility800000()	{
		try	{
			...
			long endTime = System.currentTimeMillis();
			long totalTime = endTime - startTime;
			writeOnFile(44, totalTime,Consts.NUMBERTHREAD,800000,1000);
		}
		catch (Exception e) {
			fail("Exception during the test.\nMsg:" + e.getMessage());
		}
	...
	public void testScalbility900000()	{
		try	{
			...
			long endTime = System.currentTimeMillis();
			long totalTime = endTime - startTime;
			writeOnFile(45, totalTime,Consts.NUMBERTHREAD,900000,1000);
		}
		catch (Exception e) {
			fail("Exception during the test.\nMsg:" + e.getMessage());
		}
	...
	public void testScalbility1000000()	{
		try	{
			...
			long endTime = System.currentTimeMillis();
			long totalTime = endTime - startTime;
			writeOnFile(46, totalTime,Consts.NUMBERTHREAD,1000000,1000);
		}
		catch (Exception e) {
			fail("Exception during the test.\nMsg:" + e.getMessage());
		}
